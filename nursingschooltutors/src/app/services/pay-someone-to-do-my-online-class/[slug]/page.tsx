          ...
          <div className="blog-layout">
            <div>
              <div className="page-content-wrap">
                ...
                <p>
                  <strong>{cleanLabel}</strong> is a core component of the Chamberlain University nursing curriculum. {cleanLabel.toLowerCase().includes('nr-2') || cleanLabel.toLowerCase().includes('nr-3') ? "This course builds foundational knowledge in pathophysiology, pharmacology, health assessment, or nursing practice that underpins all subsequent clinical coursework." : "This graduate-level course develops advanced competencies in nursing leadership, clinical practice, research, or specialty nursing that prepare students for advanced practice roles."} Students in this course are expected to apply evidence-based frameworks, engage with current nursing literature, and demonstrate professional clinical reasoning in all assignments.
                </p>
                <p>
